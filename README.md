...
URL: `#list` / `#detail/MK-2024-0187` / `#detail/MK-2024-0187/history`

## デモの主な操作

- 一覧の **「履歴を見る」** → 詳細の修理履歴セクションへ直接ジャンプ
- 履歴行の **「関連添付を見る」** → 対応するPDF/画像をハイライト
- 写真クリック → ライトボックス拡大
- 修理預り機（MK-2024-0187 等）→ **預り修理ステータス** ブロック表示
